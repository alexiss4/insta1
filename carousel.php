...
$page_meta_desc_key = 'carousel_meta_desc'; // Define meta description key
...
<div class="hero-section">
    <div class="container">
        ...
        <h1><?php echo _t('carousel_page_h1', 'Instagram Carousel Downloader'); ?></h1>
            ...
            <div class="col-md-8">
                <form id="instagram-form" class="download-form">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="<?php echo _t('enter_instagram_carousel_url', 'Insert Instagram carousel post link here'); ?>" name="instagram_url" id="instagram-url" required>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h2>Download All Media from Instagram Carousels</h2> <!-- This H2 could also be made dynamic if needed -->
            ...
            <p class="mt-4"><?php echo nl2br(_t('carousel_new_para1')); ?></p>
            <p><?php echo nl2br(_t('carousel_new_para2')); ?></p>
        </div>

        <div class="col-md-8 offset-md-2 mt-4"> 
            <h3><?php echo _t('carousel_extra_title', 'Carousel Download Insights'); ?></h3>
            <p><?php echo nl2br(_t('carousel_extra_p1', 'Carousels can contain a mix of photos and videos. Our tool helps you download all items from a public carousel post.')); ?></p>
            <p><?php echo nl2br(_t('carousel_extra_p2', 'The downloaded items will typically be named in sequence to help you identify their order.')); ?></p>
        </div>
    </div>
</div>
