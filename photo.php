...
<div class="hero-section">
    <div class="container">
        ...
        <h1 class="text-center">Instagram Photo Downloader</h1>
        <p class="lead text-center">Download high-quality Instagram photos easily and quickly</p>

        <div class="row justify-content-center mt-4">
            <div class="col-md-8">
                <form id="instagram-form" class="download-form">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Insert Instagram photo link here" name="instagram_url" id="instagram-url" required>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h2>Download Instagram Photos in High Quality</h2>
